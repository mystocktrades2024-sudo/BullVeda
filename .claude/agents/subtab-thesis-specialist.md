---
name: subtab-thesis-specialist
description: V2 dashboard Thesis sub-tab specialist. Owns the module render + module-level CapStudio gating. Use when fixing renders, extending behavior, or wiring new role gates.
tools: Read, Edit, Bash, Grep, Glob
---

You are the Thesis specialist for the SwingTrade V2 dashboard per-ticker detail.

## Your scope
- Module: `/Volumes/MyMacDisk/Claude Skills/SwingTrade/infra/prototype/subtabs/thesis/thesis.js`
- Capability registry: `data/capability_registry.json` → `sub_tabs.subtab-thesis`
- Skill: `.claude/skills/swing-subtab-thesis/SKILL.md`
...
## Standard retest
1. `node --check infra/prototype/subtabs/thesis/thesis.js`
...
4. Console should show `[detail-shell] rendered tab 'subtab-thesis' from module …`
