---
name: swing-risklab
description: Operational runbook for the Risk Lab surface. Use when debugging the render, fixing data binding, or extending behavior. Module-based extraction via CapStudio loader.
---

# Risk Lab — operational skill

## Source
- Module: `infra/prototype/tabs/risklab/risklab.js`
...
## Common debugging
- Check console for `[shell] rendered tab 'risklab' from module …`
- If blank: paste any `[shell] module render 'risklab' threw:` error
