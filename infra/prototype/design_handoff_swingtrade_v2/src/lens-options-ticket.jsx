      ...
      <div className="otk-strip">
        <div className="otk-ticket">
          ...
          <div className="otk-actions">
            <button className="btn btn--primary">▶ Paper-Buy {contracts} ct</button>
        ...
        <div className="otk-verdict">
          <div className="otk-verdict-top">
            <span className="otk-verdict-tag">BUY NOW</span>
        ...
        <div className="otk-payoff-col">
          <div className="otk-card-h mono">SCENARIO P&L · BSM at expiry</div>
          <OtkPayoffBig o={o} />
        </div>
      </div>
