      ...
      <div className="lens-section">
        ...
        <div className="lens-pad">
          <CrossLens lead="copper" cells={[
            ...
            { lens: "Plan",       verdict: "READY", tone: "gn",  note: "execute as-sized" },
          ]} />
        </div>
      </div>

      <div className="lens-call">
        <span className="label-cap">The Call · Portfolio</span>
        <span className="mono">
          Adds 6.8% NAV at 0.34 correl · sector still under cap. Fit.
          <b className="copper"> Send the bracket.</b>
        </span>
      </div>
    </div>
  );
...
function LensTape({ ticker, mode, sizeCat, headerStyle, kpiStyle, heroStyle }) {
  ...
  return (
    <div className="lens lens--tape">
      ...
      <div className="lens-call">
        <span className="label-cap">The Call · Tape</span>
        <span className="mono">
...
function SentimentDial() {
  ...
  const angle = -90 + v * 90;
  return (
    <svg viewBox="0 0 200 130" width="240" height="156">
      <path d="M 30 110 A 70 70 0 0 1 170 110" stroke="var(--line)" strokeWidth="10" fill="none" strokeLinecap="round" />
      <path d="M 30 110 A 70 70 0 0 1 100 40" stroke="var(--rd)" strokeWidth="10" fill="none" strokeLinecap="round" opacity="0.4" />
      <path d="M 100 40 A 70 70 0 0 1 170 110" stroke="var(--gn)" strokeWidth="10" fill="none" strokeLinecap="round" />
      <line
        x1="100" y1="110"
      ...
      />
      <circle cx="100" cy="110" r="5" fill="var(--copper)" />
      <text x="100" y="128" textAnchor="middle" className="mono" fontSize="14" fill="var(--gn)">+0.42</text>
      <text x="100" y="142" textAnchor="middle" className="mono" fontSize="9" fill="var(--ink-3)" letterSpacing="0.14em">BULLISH</text>
    </svg>
  );
}
