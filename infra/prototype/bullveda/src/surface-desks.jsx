  ...
  function SurfaceDesks({ onTicker }) {
    ...
    return React.createElement("div", { className: "dk-wrap" }, [
      React.createElement("div", { key: "sub", style: { color: "var(--dk-dim)", fontSize: "12px", margin: "0 0 10px" } },
        "Self-contained scanner · 11 desks each decide BUY on their own raw-signal checklist over the FULL universe · " + (data.live_at ? "Schwab live " + data.live_at : "close-anchored") + " · hover a verdict for its why."),
