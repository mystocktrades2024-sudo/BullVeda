# 02 Chart+ / Technicals sub-tab

## Module
`subtabs/technicals/chart.js` — extracted from elite-detail.html 2026-05-09 via CapStudio modular loader.
...
## Common debug
- Console: look for `[detail-shell] rendered tab 'technicals' from module …`
- Module render error: `[detail-shell] module render 'technicals' threw: …`
- Missing helper: add `window.X = X` exposure in source HTML

## Capability registry
`data/capability_registry.json` → `sub_tabs.technicals`
