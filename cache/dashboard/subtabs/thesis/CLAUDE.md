...
## Module
`subtabs/thesis/thesis.js` — extracted from elite-detail.html 2026-05-09 via CapStudio modular loader.
...
## Common debug
- Console: look for `[detail-shell] rendered tab 'thesis' from module …`
- Module render error: `[detail-shell] module render 'thesis' threw: …`
- Missing helper: add `window.X = X` exposure in source HTML

## Capability registry
`data/capability_registry.json` → `sub_tabs.thesis`
